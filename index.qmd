...
The biggest change in the AI tooling landscape this year is not a model. It is
a shift in what the tools accept as input: not just a task, but a **definition
of done** — and a harness that iterates against it without you. Claude's
Outcomes and `/goal`, Grok Build's plan approval, and Fable 5's
spec-up-front design all reward the same skill: writing success criteria a
grader can actually check.
